...
- Telefone, endereço e CRM são **placeholders** — substituir pelos dados reais
- O projeto é **somente front-end**, sem backend ou integração com sistemas de agendamento
